...
We believe that Asset Builder were referring to no-load AF in their table, but were not sure. It has been possible to buy American Fund F-1 class shares without the loads since 2016 (with a 3 bps higher annual expense ratio), so there is no reason for anyone that doesn't want to pay the load for advice to pay one. As shown below, we calculate that their ending value for is 3-4% too high for the Vanguard Fund, and also too low for 4 out of the 5 AF without loads. For the most part, their claim still holds up even with these adjustments at least with AF's US line-up and assuming that relative risk is not a consideration. If taxes were taken into account, it would widen the performance advantage of TMI. Still, this is a strange pattern (tilting the calculation in favor of TMI and against AF), and makes us a little suspicious of Asset Builder.
