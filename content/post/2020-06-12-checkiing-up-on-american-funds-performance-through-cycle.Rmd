...
It was probably from operating New Perspective, which was set up to own companies which have a majority of revenues of coming from outside of their country of domicile, which led American Funds to discover a new way of looking at its portfolios. In the [New Geography of Investing](https://www.capitalgroup.com/content/dam/cgc/tenants/canada/pdf/en/public/NewGeographyOfInvesting.pdf) campaign launched in 2016, they do an excellent job of explaining this concept. In addition to the country of domicile, they now disclose the geographic mix of revenues of all of their portfolios on their website, and explain clearly that it doesn't prioritize fitting its portfolios into Morningstar regional boxes at the expense of finding the best investments. 
