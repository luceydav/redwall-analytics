...
```{r 'yelp', echo=FALSE, message=FALSE, warning=FALSE, out.width='100%'}
knitr::include_graphics("/Users/davidlucey/Desktop/David/Projects/redwall-analytics/static/img/yelp.png", error = FALSE)
```
...
```{r 'storage', echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r 'dfs', echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r 'profiles', echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r 'options', echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE}
