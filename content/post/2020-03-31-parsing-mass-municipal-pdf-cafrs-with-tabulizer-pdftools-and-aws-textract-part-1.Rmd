...
That completes the first in this series of posts. In the next post [Tabulizer and pdftools Together as Super-powers - Part 2](https://redwallanalytics.com/2020/04/06/tabulizer-and-pdftools-togeteher-as-super-powers-part-2/), we will show how to the combination of pdftools and tabulizer can enable more accurate table extraction for a large number of slightly varying tables.
